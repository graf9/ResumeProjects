...
economic_history_bp = Blueprint('economic_history', __name__, template_folder='templates')

# ------------------------
# Caching Setup and Constants
# ------------------------
...
def create_figures(end_date):
    ...
    if df_dual.empty:
        fig_dual = px.line(title='GDP vs. CPI: No Overlapping Data')
    else:
        fig_dual = go.Figure()
